        ...
        <div class="bg-slate-800 border border-slate-700 rounded-lg shadow-xl p-6 mb-8">
            ...
            <form id="smtpSettingsForm" class="space-y-4">
                ...
                <div class="flex justify-end gap-3">
                    <button type="button" id="testSmtpBtn" class="px-6 py-2 bg-amber-600 text-white rounded-lg hover:bg-amber-700">
            ...
            <!-- Test Email Modal -->
            <div id="testEmailModal" class="fixed inset-0 z-50 hidden items-center justify-center bg-black/70">
                <div class="bg-slate-800 rounded-xl border border-slate-700 w-full max-w-md shadow-xl">
                    <div class="flex justify-between items-center p-4 border-b border-slate-700">
                        <h3 class="text-lg font-bold text-white"><i class="fas fa-paper-plane text-amber-400 mr-2"></i>Send Test Email</h3>
                        <button onclick="closeTestEmailModal()" class="text-slate-400 hover:text-white">
                            <i class="fas fa-times"></i>
                        </button>
                    </div>
                    <div class="p-4">
                        <p class="text-slate-400 text-sm mb-4">Enter an email address to receive a test email. This will verify your SMTP settings are working correctly.</p>
                        <div class="mb-4">
                            <label for="testEmailAddress" class="block text-sm font-medium text-slate-400 mb-1">Recipient Email</label>
                            <input type="email" id="testEmailAddress" required class="w-full bg-slate-900 border border-slate-600 rounded-lg px-4 py-2 focus:ring-2 focus:ring-amber-500 text-white" placeholder="test@example.com">
                        </div>
                    </div>
                    <div class="p-4 border-t border-slate-700 flex justify-end gap-3">
                        <button onclick="closeTestEmailModal()" class="px-4 py-2 bg-slate-700 hover:bg-slate-600 text-white rounded-lg text-sm font-medium">
                            Cancel
                        </button>
                        <button onclick="sendTestEmail()" id="sendTestEmailBtn" class="px-4 py-2 bg-amber-600 hover:bg-amber-700 text-white rounded-lg text-sm font-medium">
